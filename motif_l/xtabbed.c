 ...
 *                                                                        *
 *                                           _________XXXXXXXXXX          *
 *      Copyright (c) 1987-1996              _____________XX              *
 *      Tartan Incorporated                  _____________XX              *
 *      All Rights Reserved                  _____________XX              *
 *                                           _____________XX              *
 *                                                                        *
 *    This material is a trade secret of Tartan Incorporated and          *
 *    may not be disclosed or copied in any form without the explicit     *
 *    written permission of Tartan Incorporated.                          *
 *                                                                        *
 * ************************************************************************
 *
 * $Header: /a/CVSROOT/vi/motif_l/xtabbed.c,v 8.1 1996/12/11 15:04:06 bostic Exp $
 * $Source: /a/CVSROOT/vi/motif_l/xtabbed.c,v $
 * $Log: xtabbed.c,v $
 * Revision 8.1  1996/12/11 15:04:06  bostic
 * Initial revision
 *
 * Revision 1.3  96/09/06  15:36:03  zimmerma
 * DecC 5.3 / VMS 7.0 mods
 * 
 * Revision 1.2  96/07/31  15:41:43  zimmerma
 * slight rearranging of code for vms
 * 
 * Revision 1.1  96/07/31  11:14:37  zimmerma
 * Initial revision
 * 
 *
 * ***********************************************************************
...
** (generator version $Revision: 8.1 $ of $Date: 1996/12/11 15:04:06 $)
*/
#ifndef _XmTabs_H_
#define _XmTabs_H_
typedef enum {

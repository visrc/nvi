...
static float   XRotVersion();
static void    XRotSetMagnification();
static void    XRotSetBoundingBoxPad();
static int     XRotDrawString();
static int     XRotDrawImageString();
static int     XRotDrawAlignedString();
static int     XRotDrawAlignedImageString();
static XPoint *XRotTextExtents();
...
** (generator version $Revision: 8.3 $ of $Date: 1996/12/17 10:48:06 $)
*/
#ifndef _XmTabs_H_
#define _XmTabs_H_
typedef enum {

...
#ifndef lint
static char sccsid[] = "$Id: ex_cmd.c,v 5.4 1992/04/05 19:03:24 bostic Exp $ (Berkeley) $Date: 1992/04/05 19:03:24 $";
#endif /* not lint */
 ...
 * associated with it, which gets looped through looking for items.  The

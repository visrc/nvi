...
/* ^J  move down	*/	{m_updnto,	CURSOR,		MVMT|LNMD|VIZ},
/* ^K  not defined	*/	{NO_FUNC,	NO_ARGS,	NO_FLAGS},
/* ^L  redraw screen	*/	{v_redraw,	NO_ARGS,	NO_FLAGS|VIZ},
/* ^M  mv front next ln */	{m_updnto,	CURSOR,		MVMT|FRNT|LNMD|VIZ},
/* ^N  move down	*/	{m_updnto,	CURSOR,		MVMT|LNMD|VIZ},
/* ^O  not defined	*/	{NO_FUNC,	NO_ARGS,	NO_FLAGS},
/* ^P  move up		*/	{m_updnto,	CURSOR,		MVMT|LNMD|VIZ},
...
/* ^X  move to phys col	*/	{m_tocol,	CURSOR,		NREL|VIZ},
...
/* SPC move right,like l*/	{m_right,	CURSOR,		MVMT|VIZ},
...
/*  *  not defined	*/	{NO_FUNC,	NO_ARGS,	NO_FLAGS},
#endif
/*  +  mv front next ln */	{m_updnto,	CURSOR,		MVMT|FRNT|LNMD|VIZ},
#ifndef NO_CHARSEARCH
/*  ,  reverse [fFtT] cmd*/	{m__ch,		CURSOR,		MVMT|INCL|VIZ},
#else
/*  ,  not defined	*/	{NO_FUNC,	NO_ARGS,	NO_FLAGS},
#endif
/*  -  mv front prev ln	*/	{m_updnto,	CURSOR,		MVMT|FRNT|LNMD|VIZ},
...
/*  H  move to row	*/	{m_row,		CURSOR,		MVMT|FRNT|VIZ},
...
/*  K  not defined	*/	{NO_FUNC,	NO_ARGS,	NO_FLAGS},
#endif
/*  L  move to last row	*/	{m_row,		CURSOR,		MVMT|FRNT|VIZ},
/*  M  move to mid row	*/	{m_row,		CURSOR,		MVMT|FRNT|VIZ},
...
/*  j  move down	*/	{m_updnto,	CURSOR,		MVMT|NCOL|LNMD|VIZ},
/*  k  move up		*/	{m_updnto,	CURSOR,		MVMT|NCOL|LNMD|VIZ},
/*  l  move right	*/	{m_right,	CURSOR,		MVMT|VIZ},

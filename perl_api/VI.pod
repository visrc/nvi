...
This pseudo module is available to perl programs
run from within nvi and provides access to the files
being edited and some internal data.
...
Line number of the first line of the selected range or 
of the file if no range was specified.

=item * $StopLine

Line number of the last line of the selected range or 
of the file if no range was specified.
